...
Some scripts may utilize external tools for a better experience, but this should
never be a requirement for a tool work, since a personalized environment can not
be guaranteed.

While the tools strive to be general usage, they are tailored to fit my personal
workflow, and the type of projects I'm involved with, thus slight bias will be
towards OS/Networking/System Integration
